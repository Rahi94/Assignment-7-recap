...
const Blog = ({ blog, handleAddToCook }) => {
    ...
    return (
        <div className='border-2 border-gray-300 rounded-xl p-4'>
            ...
            <button onClick={() => handleAddToCook(blog)} className='bg-green-500 text-white p-3 rounded-2xl mt-6 font-semibold flex mx-auto'>Want to cook</button>
        </div>
    );
};
